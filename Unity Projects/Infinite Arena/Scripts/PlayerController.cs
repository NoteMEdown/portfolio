...
{
    public class PlayerController : vp_CharacterController
    {
        ...
        // physics trigger
        protected MeshCollider m_TriggerCollider = null;     // trigger collider for incoming objects to detect us
        ...
        [Tooltip("The reference to the PlayerManager script on the current player")]
        public PlayerManager playerManager;
        [Tooltip("The reference to the Mesh of the player")]
        ...
        protected override void Start()
        {
            ...
            if (PhysicsHasCollisionTrigger)
            {
                ...
                m_TriggerCollider = m_Trigger.AddComponent<MeshCollider>();
                m_TriggerCollider.isTrigger = true;
                m_TriggerCollider.sharedMesh = playerMesh;
        ...
        protected virtual void OnStart_Jump()
        {
            ...
            m_MotorThrottle.y = ((MotorJumpForce * timesJumped) / Time.timeScale);
        ...
        {
            get { return true; }// return m_MotorJumpDone; }
        }
